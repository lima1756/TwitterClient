...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1"; // Twitter API URL
	public static final String REST_CONSUMER_KEY = Secrets.TWITTERAPI;
	public static final String REST_CONSUMER_SECRET = Secrets.TWITTERSECRET;
